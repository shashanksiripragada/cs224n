...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[
        ...
        X = self.model_embeddings_source(source_padded) ## src_len x b --> src_len x b x e
        ...
        last_hidden = torch.cat((last_hidden[0], last_hidden[1]), 1) #columns 
